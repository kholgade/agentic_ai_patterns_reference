...
1. **Read the [Quick Navigation](./README.md#quick-navigation) section** in the main README for pattern groups
...
Go to **[Pattern Groups](./pattern-groups/README.md)** for detailed comparisons:
